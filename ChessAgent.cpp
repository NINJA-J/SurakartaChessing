// NegaScout.cpp: implementation of the ChessAgent class zsj.
//
//////////////////////////////////////////////////////////////////////
...
CHESSMOVE ChessAgent::SearchAGoodMove(BYTE position[6][6], int m_isPlayerBlack) {
	int score;
...
int ChessAgent::NegaScout_TT_HH(int depth, int num, int m_Type)
{
	int t;
	int Count, i;
	BYTE type;
...
int ChessAgent::NegaScout_ABTree(int depth, int m_Type, int alpha, int beta) {
#ifdef ABDebug
...
int ChessAgent::negaScoutMinWin(int depth, int m_Type, int alpha, int beta)
{
	CHESSMOVE moveList[200];
	//0 floor is max floor
	//depth of 0 floor = m_nMaxDepth
